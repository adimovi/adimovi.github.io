...
document.addEventListener("DOMContentLoaded", function() {
    const newsItems = document.querySelectorAll('.blog-box');
    const totalPages = Math.ceil(newsItems.length / 3); // Calculate total pages
    ...
    const pageButtons = document.querySelectorAll('.page-link:not(:first-child):not(:last-child)');
